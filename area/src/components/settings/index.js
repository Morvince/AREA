  ...
  const isGithubConnected = useGithubConnected();
    ...
    return (
      <>
        ...
        <Icon icon="mdi:twitch" width="100" style={{ position: 'absolute', left: '18%', top: "650px" }}/>
        {isTwitchConnected.isSuccess && isTwitchConnected.data.data.connected ?
          <Connected top="665px" left="25.5%" >Connected</Connected> :
          <Connect to="/" top="665px" left="26.5%" data-value="twitch" onClick={handleConnectServices} >Connect</Connect>
        }
