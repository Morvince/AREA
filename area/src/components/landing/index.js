...
const Landing = () => {
    ...
    return (
        <>
            ...
            <Rect top="3800px" height="1100px" color="black" Rect />
            <Text lineheight="1.2" fontsize="50px" top="360%" left="20%"
                color="white" fontweight="bold" > Connect apps together and let automations work </Text>
            <SecondWave top="335%" height="1000px" color="#373b48" SecondWave />

            {/* final part */}
            <img src={cuircuit} alt="image" style={{ position: 'absolute', top: '425%', height: "600px", width: "100%", borderRadius: "175px", opacity: 0.3}} />
            <Text lineheight="1.2" fontsize="40px" top="410%" left="20%"
